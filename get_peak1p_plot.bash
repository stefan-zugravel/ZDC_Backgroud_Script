...
if [ "$STR" == "SPECIFIC" ]; then
    ...
    rm -rf "results/$(curl -s "http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/RunNumber=$irun?Accept=application/json" | jq -r '.objects[0].RunNumber')/1p"
    mkdir "results/$(curl -s "http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/RunNumber=$irun?Accept=application/json" | jq -r '.objects[0].RunNumber')"      > /dev/null 2>&1
    mkdir "results/$(curl -s "http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/RunNumber=$irun?Accept=application/json" | jq -r '.objects[0].RunNumber')/1p"   > /dev/null 2>&1
else
    ...
    rm -rf "results/$(curl -s 'http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/?Accept=application/json' | jq -r '.objects[0].RunNumber')/1p"
    mkdir "results/$(curl -s 'http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/?Accept=application/json' | jq -r '.objects[0].RunNumber')"                > /dev/null 2>&1
    mkdir "results/$(curl -s 'http://ali-qcdb-gpn.cern.ch:8083/browse/qc/ZDC/MO/QcZDCRecTask/h_TDC_ZPA_TC_A/?Accept=application/json' | jq -r '.objects[0].RunNumber')/1p"             > /dev/null 2>&1
fi
